...
def add_user(command: str):
    ...
    if command is None:
        ...
        try:
            first_name, last_name, email, password, password_repeat, secure_key = command.split(' ')
        except Exception as e:
            print(e)
            ...
            if command is None:
                ...
                c.execute("INSERT INTO users VALUES (?, ?, ?, ?, ?, ?)", (first_name, last_name, email,password,password_repeat,secure_key))
